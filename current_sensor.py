###  BAAMSAT CAMERA PAYLOAD CURRENT SENSOR ###
...
class Current_sensor():
    def __init__():        
        ...
        self.ina219_battery = INA219(i2c_bus)
        self.ina219_heat = INA219(i2c_bus,0x41)
        self.ina260_raspberry = adafruit_ina260.INA260(i2c_bus,0x44)



        # optional : change configuration to use 32 samples averaging for both bus voltage and shunt voltage
        self.ina219_battery.bus_adc_resolution = ADCResolution.ADCRES_12BIT_32S
        self.ina219_battery.shunt_adc_resolution = ADCResolution.ADCRES_12BIT_32S
        # optional : change voltage range to 16V
        self.ina219_battery.bus_voltage_range = BusVoltageRange.RANGE_16V
